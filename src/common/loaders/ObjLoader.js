...
class JSONLoader {
    ...
    load(url, onLoad, onProgress, onError) {
        ...
        fs.readFile(url, 'utf-8', (error, data) =>{
            ...
            // 错误处理
            if (error) {
                if ( onError || this.manager.onError ) {
                    onError ? onError (url, data) : this.manager.onError(url);
                }
            }
            ...
            object = this.parse( json, texturePath );
    ...
    static parseModel( json, geometry ) {
    ...
    static parseSkin( json, geometry ) {
    ...
    static parseMorphing( json, geometry ) {
    ...
    static parseAnimations( json, geometry ) {
    ...
    parse( json, texturePath ){
        ...
        JSONLoader.parseModel( json, geometry );
        JSONLoader.parseSkin( json, geometry );
        JSONLoader.parseMorphing( json, geometry );
        JSONLoader.parseAnimations( json, geometry );
